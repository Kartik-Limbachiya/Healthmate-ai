...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col relative">
      ...
      {/* Features Section */}
      <section className="py-16 px-4 md:px-6 bg-gray-50 dark:bg-secondary relative overflow-hidden">
        <div className="container mx-auto">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-secondary/80 rounded-lg p-6 shadow-md flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
              <HeartbeatIcon size={40} color="#FF9500" beatsPerMinute={75} className="mb-3" />
              <AnimatedStat value={10000} suffix="+" className="text-3xl font-bold" />
              <p className="text-sm text-muted-foreground">Steps Tracked Daily</p>
            </div>

            <div className="bg-white dark:bg-secondary/80 rounded-lg p-6 shadow-md flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
              <div className="mb-3 text-primary text-4xl">💪</div>
              <AnimatedStat value={500} suffix="+" className="text-3xl font-bold" />
              <p className="text-sm text-muted-foreground">Workout Plans</p>
            </div>

            <div className="bg-white dark:bg-secondary/80 rounded-lg p-6 shadow-md flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
              <div className="mb-3 text-primary text-4xl">🥗</div>
              <AnimatedStat value={1000} suffix="+" className="text-3xl font-bold" />
              <p className="text-sm text-muted-foreground">Healthy Recipes</p>
            </div>

            <div className="bg-white dark:bg-secondary/80 rounded-lg p-6 shadow-md flex flex-col items-center justify-center transform hover:scale-105 transition-transform">
              <div className="mb-3 text-primary text-4xl">🏆</div>
              <AnimatedStat value={98} suffix="%" className="text-3xl font-bold" />
      ...
      <section className="py-16 px-4 md:px-6 relative">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold mb-4">Featured Workouts</h2>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 md:px-6 bg-secondary text-white relative overflow-hidden">
        {/* Animated elements */}
        ...
        <div className="container mx-auto text-center relative z-10">
          <HeartbeatIcon size={48} color="#4CD964" beatsPerMinute={70} className="mx-auto mb-6" />
          ...
          <Button size="lg" className="bg-accent text-secondary hover:bg-accent/90 group relative overflow-hidden">
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-transform">
              <AnimatedStat value={5000} suffix="+" className="text-2xl font-bold text-accent" />
              <p className="text-sm mt-1">Active Users</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-transform">
              <AnimatedStat value={200} suffix="+" className="text-2xl font-bold text-accent" />
              <p className="text-sm mt-1">Expert Trainers</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-transform">
              <AnimatedStat value={15000} suffix="+" className="text-2xl font-bold text-accent" />
              <p className="text-sm mt-1">Workouts Completed</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-transform">
              <AnimatedStat value={95} suffix="%" className="text-2xl font-bold text-accent" />
